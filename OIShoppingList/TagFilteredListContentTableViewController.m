//
//  TagFilteredListContentTableViewController.m
//  OIShoppingList
//
...
@interface TagFilteredListContentTableViewController ()
...
@implementation TagFilteredListContentTableViewController
...
- (void)setupFetchedResultsController // attaches an NSFetchRequest to this UITableViewController
{
    ...
    request.predicate = [NSPredicate predicateWithFormat:
                         @"list_id.name = %@ and item_id.tags = %@"
                         , self.listToDisplay.name, self.tagFilter];
